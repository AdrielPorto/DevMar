...
export const ptBR = {
  ...
  quote: { 
    ...
    segmentLabel: 'Qual o segmento da sua empresa?',
    segmentPlaceholder: 'Selecione ou busque o segmento',
    segmentSearchPlaceholder: 'Buscar segmento...',
    segmentNotFound: 'Nenhum segmento encontrado',
    ...
    deadlineLabel: 'Nível de Urgência',
