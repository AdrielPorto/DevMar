export const ptBR = {
  ...
  home: {
    ...
    card2Title: 'Consultoria Especializada',
  ...
  about: {
    ...
    strengthP1: 'A <strong>DevMar</strong> é uma cooperativa de profissionais de tecnologia comprometida com a prestação de serviços de alto nível. Nosso modelo de negócios elimina intermediários, conectando clientes diretamente a especialistas seniores.',
    strengthP2: 'Nosso objeto social abrange desde o desenvolvimento de software customizado e consultoria estratégica em TI até a implementação de soluções complexas de Inteligência Artificial e Segurança da Informação.',
    ...
    innovationDesc: 'Estamos sempre na vanguarda da IA, Cloud e Desenvolvimento Moderno.',
    ethicsTitle: 'Ética',
  ...
  quote: {
    ...
    descriptionPlaceholder: 'Descreva detalhadamente o que você precisa: objetivos, funcionalidades desejadas, público-alvo, integrações necessárias, etc.',
    deadlineLabel: 'Prazo Estimado',
    deadlinePlaceholder: 'Selecione um prazo',
    budgetLabel: 'Faixa de Orçamento',
    budgetPlaceholder: 'Selecione uma faixa',
    
    deadlineUrgent: 'Urgente (até 1 mês)',
    deadlineShort: 'Curto prazo (1-3 meses)',
    deadlineMedium: 'Médio prazo (3-6 meses)',
    deadlineLong: 'Longo prazo (6+ meses)',
    deadlineFlexible: 'Prazo flexível',
  ...
  footer: {
    ...
    webDev: 'Desenvolvimento Web & App',
